...
## Summarise your Github for me in a few of paragraphs...

My current main project is [CheckTIck](https://checktick.uk/home) ([repository](https://github.com/eatyourpeas-ltd/checktick)) and I am really excited about it - it is a survey platform built for the NHS. It supports datasets for common use cases (NHS lists for ethnicity, sex, all NHS trusts and so) and hosts often-used question groups, like the PHQ-9. I am building it to meet the OWASP criteria. It complies with DSPT, DTAC and clinical safety. All data is encrypted. 

The other project I am proudest of is the [RCPCH growth charts API](https://github.com/rcpch). This is the first time a medical royal college (the Royal College of Paediatrics and Child Health) has undertaken to host its own code. Coding a growth chart involves an amazing nerdy mix of interest in childhood growth, stats, charting and data visualisation. The team putting the API together are amazing and I am very privileged to be learning from some of the big names in UK Children's Growth Chart development. The collection of projects now include a react chart that consumes the API, a flutter app and repository for international growth references.
...
I work mostly now in paediatric diabetes and endocrinology and there are projects here for that. [Endocrinologist](https://github.com/eatyourpeas/endocrinologist) brings data only really found in papers into the hands of clinicians to use as normative values. There are charts of published standards for final height, glucose calculators and so on. Other fun projects include [Certify](https://github.com/eatyourpeas/certify), an attendance certificate generator for conferences, and [STPEG](https://github.com/eatyourpeas/stpeg) a site for the South Thames Paediatric Endocrine Group regular educational events.

Other projects dabble in and around adolescent health or medical training. There are projects in python, javascript/typescript, react, meteor, ionic, android and ios and dart and flutter.
